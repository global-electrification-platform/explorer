...
export default function GlobalInput (params) {
  return (
    <React.Fragment>
      <h2>Input data</h2>
      <p>
      ...
      <p>
        ...
        erat wisi, condimentum sed, commodo vitae, ornare sit amet,
        wisi. Aenean fermentum, elit eget tincidunt condimentum, eros
        ipsum rutrum orci, sagittis tempus lacus enim ac dui. Donec non
        enim in turpis pulvinar facilisis. Praesendapibus, neque id
